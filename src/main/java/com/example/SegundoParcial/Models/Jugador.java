...
public class Jugador {
    ...
    public Jugador(int id_jugador, String nombre, String posicion, int dorsal, LocalDate fecha_nac, String nacionalidad, Equipo equipo, List<EstadisticaJugador> estadisticas) {
